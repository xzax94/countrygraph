...
public final class LineChartMeasureExceptionHandler implements ExceptionHandler
{
	private static final String DIALOGUE_MESSAGE = "Line Chart requires at least 1 measure!";
