...
public final class IncomeIndexDao implements StatisticDao<IncomeIndex>
{
	private static final String SELECT_QUERY = "SELECT * FROM income_index WHERE country_id=? AND year BETWEEN ? AND ?";

	@Override
	public List<IncomeIndex> findAll(MeasureRequest measureRequest) 
	{
