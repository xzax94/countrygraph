...
public final class GDPTotalDao implements StatisticDao<GDPTotal>
{
	private static final String SELECT_QUERY = "SELECT * FROM gdp_total WHERE country_id=? AND year BETWEEN ? AND ?";

	@Override
	public List<GDPTotal> findAll(MeasureRequest measureRequest) 
	{
